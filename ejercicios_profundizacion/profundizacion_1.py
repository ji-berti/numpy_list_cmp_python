...
if __name__ == '__main__':
    ...
    lista_numeros = np.array([random.randint(1,10) for x in range(3)])
    if sum(lista_numeros) <= 21:
        print(f'{lista_numeros[0]} + {lista_numeros[1]} + {lista_numeros[2]} = {sum(lista_numeros)}')
    else:
        print('Perdiste')
